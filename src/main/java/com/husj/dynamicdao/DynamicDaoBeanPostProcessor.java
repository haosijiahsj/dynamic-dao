 ...
 */
@Setter
public class DynamicDaoBeanPostProcessor implements BeanPostProcessor {

    private DataSource dataSource;
    private JdbcTemplate jdbcTemplate;

    public DynamicDaoBeanPostProcessor() {}

    public DynamicDaoBeanPostProcessor(DataSource dataSource) {
        this.dataSource = dataSource;
    }

    public DynamicDaoBeanPostProcessor(JdbcTemplate jdbcTemplate) {

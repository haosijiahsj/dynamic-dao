...
public class DynamicDaoProxyFactory {
    ...
    public static <T> T create(Class<T> interfaceType, JdbcTemplate jdbcTemplate, InjectDaoConfiguration configuration) {
        ...
        DynamicDaoInvocationHandler invocationHandler = new DynamicDaoInvocationHandler(jdbcTemplate, configuration);
